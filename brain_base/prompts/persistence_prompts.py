...
```json
{
  "title": "Docker Compose 启动 RAGFlow",
  "summary": "本节介绍如何用 docker compose 启动 RAGFlow，包括镜像拉取、端口映射与首次登录步骤。",
  "keywords": ["RAGFlow", "Docker Compose", "镜像拉取", "端口映射", "首次登录"],
  "questions": [
    "如何用 Docker 启动 RAGFlow？",
    "RAGFlow 默认占用哪些端口？",
    "RAGFlow 首次登录的默认账号是什么？",
    "How to bring up RAGFlow with docker compose?"
  ]
}
```
"""
